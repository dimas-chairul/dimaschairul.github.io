                    ...
                    <div class="card shadow-sm p-3">
                        <div class="card-body">
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="title" value="<?= htmlspecialchars($title["title"]) ?>" disabled>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="genre" value="<?= htmlspecialchars($genre["genre"]) ?>" disabled>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="director" value="<?= htmlspecialchars($director["director"]) ?>" disabled>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="release_year" value="<?= htmlspecialchars($release_year["release_year"]) ?>" disabled>
